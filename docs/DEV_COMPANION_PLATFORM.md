...
- Skills under `~/.local/share/dots-ai/skills/`:
  - **Companion layers** (e.g. `dots-ai-dev-companion`, `sunstone-dev-companion`)
  - **Workflow skills** (WHAT) (e.g. `workflow-generic-project`, `workflow-sunstone-credit-data-project`)
