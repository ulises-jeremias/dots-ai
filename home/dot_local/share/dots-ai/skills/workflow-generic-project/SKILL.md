...
description: >-
  ...
  on tickets, draft PR via delegated forge skills. Not for Sunstone Credit (use workflow-sunstone-credit-data-project).
---
...
This workflow is **independent** from **Sunstone Credit**. **Do not mix** them on the same task.

## Mode selection (mandatory)

- Use **this skill** when the task is **not** Sunstone Credit–scoped.
- If the user mentions **Sunstone Credit** or a **Jira ticket in that engagement** (e.g. `SUNENG-*`) → use **`workflow-sunstone-credit-data-project`**, not this skill.
- If unclear → **ask** which workflow applies before proceeding.
...
1. **Intake:** Identify ticket IDs; classify workflow (this vs Sunstone); retrieve linked docs via appropriate skills.
...
- [ ] Correct workflow (Generic vs Sunstone) confirmed
