...
2. **Classify** the user request:
   ...
   - **Generic dots-ai/client delivery** → **dots-ai-dev-companion** (companion framing) + **workflow-generic-project** (WHAT).
...
4. **If uncertain**, ask which workflow applies before heavy work, then fall back to this skill's discovery pass.
