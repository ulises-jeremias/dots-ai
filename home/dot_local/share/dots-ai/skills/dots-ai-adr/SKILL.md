...
name: dots-ai-adr
description: >-
  WHAT — Create and maintain Architecture Decision Records (ADRs) per the dots-ai process. Covers when to write an ADR, required sections, review, and linking to epics/PRs. English for cross-team artifacts unless the user asks otherwise.
---
...
1. **Confirm the decision qualifies** (new service, tech selection, schema change, deployment change, etc.) per the dots-ai "When to Create an ADR" criteria.
